...
f = open("smile1-bifid.png.enc", "wb")
#f = open("bifid-odd.txt.enc", "wb")
for i in range(len(var)):
    f.write(var[i])
f.close()

# open ciphertext file
file = open("smile1-bifid.png.enc", "rb")
#file = open("bifid-odd.txt.enc", "rb")
...
f = open("smile1-bifid-decrypted.png", "wb")
#f = open("bifid-odd-decrypted.txt", "wb")
for i in range(len(var)):
    f.write(var[i])
f.close()
